    ...
    return (
        <div className="absolute h-1/2 w-1/3 inset-0 m-auto">
            <form>
                ...
                <input type="text" name="Username" placeholder="Username" className="block h-14 w-4/6 rounded-2xl mx-auto my-4 text-2xl p-2" required/>
                ...
                <button type="submit" className="block h-14 w-4/6 rounded-2xl mx-auto my-4 text-3xl p-2 bg-[#7f7f7f]">SignUp</button>
            </form>
        </div>
    );
}
