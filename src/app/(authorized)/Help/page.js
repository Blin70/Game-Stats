    ...
    return (
      <>
          ...
          <div className="w-full flex flex-col items-center">
            <Textarea id="HelpMessage" name="HelpMessage" placeholder="Type your message here." className="w-1/2 h-96 bg-transparent border-black text-black text-md focus-visible:ring-0 focus-visible:ring-offset-0"  />
